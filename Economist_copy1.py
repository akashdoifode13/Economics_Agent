...
# Function to create PDF report - Removed
# def create_pdf_report(markdown_content, filename):
#     """
#     Converts markdown content to PDF and returns the PDF as bytes.
#     """
#     pdf_bytes = convert_from_markdown(markdown_content)
#     return pdf_bytes
        ...
        with tabs[0]: # Economic Analysis Tab
            ...
            try:
                ...
                if full_response_text:
                    ...
                    # pdf_filename = f"Economic_Analysis_{country_name}.pdf"
                    # pdf_bytes = create_pdf_report(formatted_response, pdf_filename) # Create PDF from markdown
                    ...
                    #     key="pdf_download_button" # Unique key
                    # )
